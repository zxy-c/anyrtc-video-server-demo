...
class AgoraClient(private val customerId: String, private val customerSecret: String, private val appId: String) {
...
//            request.headers.contentType = MediaType(MediaType.APPLICATION_JSON, StandardCharsets.UTF_8)
    ...
    fun acquire(cname: String, uid: String): String {
        ...
        return restTemplate.exchange<AgoraBasicResponse<AnyRTCAcquireResponse>>(
    ...
    ): ResponseEntity<AgoraBasicResponse<StartRecordResponse>> {
